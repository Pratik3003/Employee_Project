...
function filterbyprofession() {
    ...
    arr.forEach((item) => {
        if (item.profession === dropdownValue) {
            ...
            divElement.innerText = item.id + ".\xa0\xa0\xa0\xa0\xa0\xa0\xa0" + "Name: " + item.name + "\xa0\xa0\xa0\xa0\xa0\xa0\xa0" + "    Profession:  " + item.profession + "\xa0\xa0\xa0\xa0\xa0\xa0\xa0" + "  Age:  " + item.age;
